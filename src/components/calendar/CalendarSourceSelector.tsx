...
import { Download, Smartphone, Copy, Check, Save, CalendarHeart } from "lucide-react";
...
export function CalendarSourceSelector({ onUrlChange }: CalendarSourceSelectorProps) {
  ...
  const handleSelectAll = () => {
    if (sources) setSelectedSources(sources.map(s => s.id));
  };
  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      <AccordionItem value="calendar-sync" className="border rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 border-primary/20">
        <AccordionTrigger className="px-6 py-4 hover:no-underline">
          <div className="flex items-center gap-3 text-left">
            <CalendarHeart className="h-6 w-6 text-primary shrink-0" />
            <div>
              <p className="font-semibold text-base">¿No quieres perderte ningún evento del ecosistema?</p>
              <p className="text-sm text-muted-foreground font-normal">
                Descarga el calendario, sincronízalo con tu celular y mantente al día con los eventos de las comunidades que te interesan
              </p>
            </div>
          </div>
        </AccordionTrigger>
          ...
          <div className="space-y-6 pt-2">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <Button variant="ghost" size="sm" onClick={handleSelectAll}>Todas</Button>
                    <Button variant="ghost" size="sm" onClick={handleDeselectAll}>Ninguna</Button>
                  </div>
                </div>
            ...
            <div className="p-4 bg-muted/30 rounded-lg">
              ...
              <div className="grid gap-4 sm:grid-cols-2 text-sm">
                <div>
                  <h5 className="font-medium flex items-center gap-2 mb-2">🍎 iPhone / iPad</h5>
                ...
                <div>
                  <h5 className="font-medium flex items-center gap-2 mb-2">🤖 Android / Google Calendar</h5>
                  <ol className="text-muted-foreground space-y-1 list-decimal list-inside">
